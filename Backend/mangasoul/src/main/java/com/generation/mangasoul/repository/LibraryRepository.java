...
public interface LibraryRepository extends JpaRepository<Library, Long>{
	...
	@Query("SELECT l FROM Library l " + "JOIN FETCH l.manga " + "WHERE l.user.id = :userId " +
	"AND LOWER(l.manga.title) LIKE LOWER(CONCAT('%', :keyword, '%'))")
	public List<Library> findByUserAndTitleContaining(@Param("userId") Long userId, @Param("keyword") String keyword);
